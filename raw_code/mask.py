# -*- coding: utf-8 -*-
"""
Created on Mon Jul 27 18:06:07 2020
...
def run_model(image_input):
    ...
    with tf.Session() as sess:
        ...
        #conv_g = sess.run(tf.get_default_graph().get_tensor_by_name('conv1/Relu:0'),feed_dict={eval_data: image_input})
        ...
        for i in range(conv_g.shape[3]):
            ...
            plt.imsave("./mask9-0.5%/conv9_mask_" + str(i) + "_1.png",temp,cmap = 'Greys')
        #print(result)
